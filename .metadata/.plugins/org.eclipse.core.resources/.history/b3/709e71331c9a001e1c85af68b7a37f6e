...
CREATE TABLE IF NOT EXISTS TBL_BLACKLIST(
	...
	BLACK_REGIST_DATE date NOT NULL,
	BLACK_STATUS varchar(20) DEFAULT 'active' NOT NULL,
	BLACK_UPDATE_DATE date
	)ENGINE=innodb;
...
CREATE TABLE IF NOT EXISTS TBL_BUSINESS(
	...
	USER_NO int NOT NULL,
	BUSINESS_REGIST_DATE date NOT NULL,
...
CREATE TABLE IF NOT EXISTS TBL_HOLIDAY(
	...
	HOLIDAY_REGIST_DATE date NOT NULL,
	HOLIDAY_UPDATE_DATE date,
	HOLIDAY_STATUS varchar(255) DEFAULT 'active' NOT NULL,
...
-- 8. 이용시간 테이블
DROP TABLE IF EXISTS TBL_TIME_SCHEDULE;

CREATE TABLE IF NOT EXISTS TBL_TIME_SCHEDULE(
	TIME_SCHEDULE_NO int PRIMARY KEY AUTO_INCREMENT,
	START_TIME time NOT NULL,
	END_TIME time NOT NULL,
	TIME_STATUS varchar(20) DEFAULT 'N',
	BUSINESS_NO int NOT NULL,
	LOOF_TIME time NOT NULL,
	FOREIGN key(BUSINESS_NO) REFERENCES TBL_BUSINESS(BUSINESS_NO)
	)ENGINE=innodb;
...
CREATE TABLE IF NOT EXISTS TBL_ROOM(
	...
	ROOM_REGIST_DATE date NOT NULL,
	ROOM_UPDATE_DATE date,
...
CREATE TABLE IF NOT EXISTS TBL_ROOM_IMAGE(
	...
	ROOM_IMAGE_REGIST_DATE date NOT NULL,
	ROOM_IMAGE_UPDATE_DATE date,
...
CREATE TABLE IF NOT EXISTS TBL_RESERVATION(
	...
	RESERVATION_TIME time NOT NULL, -- 시간 이렇게 하는 게 맞나?
	...
	RESERVATION_CANCEL_DATE date,
	RESERVATION_REGIST_DATE date NOT NULL,
	ROOM_NO int NOT NULL,
	FOREIGN key(USER_NO) REFERENCES TBL_USER(USER_NO),
	FOREIGN KEY(ROOM_NO) REFERENCES TBL_ROOM(ROOM_NO)
	)ENGINE=innodb;
...
CREATE TABLE IF NOT EXISTS TBL_REPORT(
	...
	REPORT_REGIST_DATE date NOT NULL,
	REPORT_DONE varchar(20) DEFAULT 'un_done' NOT NULL,
	USER_NO int NOT NULL,
	REPORT_DONE_DATE date,
-- 	REPORT_DETAIL_NO int NOT NULL,
	FOREIGN KEY(USER_NO) REFERENCES TBL_USER(USER_NO)
-- 	FOREIGN KEY(REPORT_DETAIL) REFERENCES TBL_
	)ENGINE=innodb;

-- 16. 신고 사유 테이블
DROP TABLE IF EXISTS TBL_REPORT_REASON;

CREATE TABLE IF NOT EXISTS TBL_REPORT_REASON(
	REPORT_REASON_NO int PRIMARY KEY AUTO_INCREMENT,
	REPORT_REASON_NAME varchar(255) NOT NULL,
	REPORT_NO int NOT NULL,
	FOREIGN key(REPORT_NO) REFERENCES TBL_REPORT(REPORT_NO)
	)ENGINE=innodb;
...
CREATE TABLE IF NOT EXISTS TBL_QNA(
	...
	USER_NO int NOT NULL,
	QNA_CONTENTS varchar(500) NOT NULL,
	QNA_REGIST_DATE date NOT NULL,
	QNA_UPDATE_DATE date,
	QNA_STATUS varchar(20) DEFAULT 'Y' NOT NULL,
	ROOM_NO int NOT NULL,
	FOREIGN KEY(USER_NO) REFERENCES TBL_USER(USER_NO),
	FOREIGN KEY(ROOM_NO) REFERENCES TBL_ROOM(ROOM_NO)
	)ENGINE=innodb;
...
CREATE TABLE IF NOT EXISTS TBL_QNA_REPLY(
	QNA_REPLY_NO int PRIMARY KEY AUTO_INCREMENT,
	USER_NO int NOT NULL,
	QNA_REPLY_CONTENTS varchar(500) NOT NULL,
	QNA_REPLY_REGIST_DATE date NOT NULL,
	QNA_NO int NOT NULL,
	QNA_REPLY_STATUS varchar(20) DEFAULT 'Y' NOT NULL,
	QNA_REPLY_UPDATE_DATE date,
	FOREIGN KEY(USER_NO) REFERENCES TBL_USER(USER_NO),
	FOREIGN KEY(QNA_NO) REFERENCES TBL_QNA(QNA_NO)
	)ENGINE=innodb;
...
CREATE TABLE IF NOT EXISTS TBL_REVIEW(
	...
	REVIEW_RATING INT,
	REVIEW_READ_STATUS VARCHAR(20) NOT NULL,
	REVIEW_REGIST_DATE DATE NOT NULL,
	RESERVATION_NO INT NOT NULL,
	REVIEW_UPDATE_DATE DATE,
	REVIEW_STATUS VARCHAR(20) DEFAULT 'active' NOT NULL,
	ROOM_NO int NOT NULL,
	FOREIGN KEY(USER_NO) REFERENCES TBL_USER(USER_NO),
...
CREATE TABLE IF NOT EXISTS TBL_REVIEW_REPLY(
	...
	REVIEW_REPLY_REGIST_DATE DATE NOT NULL,
	REVIEW_REPLY_UPDATE_DATE DATE,
...
CREATE TABLE IF NOT EXISTS TBL_REVIEW_IMAGE(
	...
	REVIEW_IMAGE_REGIST_DATE DATE NOT NULL,
	REVIEW_IMAGE_UPDATE_DATE DATE,
...
CREATE TABLE IF NOT EXISTS TBL_ANNOUNCEMENT(
	...
	ANNOUNCEMENT_REGIST_DATE DATE NOT NULL,
	ANNOUNCEMENT_CONTENTS VARCHAR(500) NOT NULL,
	ANNOUNCEMENT_UPDATE_DATE DATE,
...
CREATE TABLE IF NOT EXISTS TBL_ANNOUNCEMENT_IMAGE(
	...
	ANNOUNCEMENT_IMAGE_REGIST_DATE DATE NOT NULL,
	ANNOUNCEMENT_IMAGE_UPDATE_DATE DATE,
...
CREATE TABLE IF NOT EXISTS TBL_INQUIRY(
	...
	USER_NO INT NOT NULL,
	INQUIRY_REGIST_DATE DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS TBL_INQUIRY_REPLY(
	...
	INQUIRY_REPLY_REGIST_DATE DATE NOT NULL,
	INQUIRY_REPLY_STATUS VARCHAR(20) DEFAULT 'active' NOT NULL,
	INQUIRY_REPLY_UPDATE_DATE DATE,
...
CREATE TABLE IF NOT EXISTS TBL_INQUIRY_IMAGE(
	...
	INQUIRY_IMAGE_REGIST_DATE DATE NOT NULL,
	INQUIRY_IMAGE_UPDATE_DATE DATE,
