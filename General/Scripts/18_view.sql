...
INSERT INTO hansic VALUES (99, '수정과맛국밥', 5500, 4, 'Y'); # 조회에서는 view를 많이 쓰지만, 등록/수정/삭제에서는 잘 쓰지 않는다.(가능하지만 안한다.)
...
-- view에 쓰인 subQuery안에 연산 결과 컬럼도 사용이 가능하다.
CREATE VIEW hansic AS
SELECT
	menu_name AS "메뉴명",
...
CREATE OR REPLACE VIEW hansic AS # 기존 뷰 초기화, 재정의
SELECT 
	a.menu_code AS "메뉴코드",
	a.menu_name AS "메뉴명",
