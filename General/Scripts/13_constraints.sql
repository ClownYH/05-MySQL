...
/* 제약 조건
 * 테이블 작성 시 각 칼럼에 값을 기록에 대한 제약 조건을 설정할 수 있다.
 * 데이터 무결성 보장을 목적으로 한다.
...
VALUES
	(4, 'user04', 'pass04', '박길동', '남', '010-2322-2323');
	
-- not null 제약 조건은 null을 허용하지 않기 때문에 아래의 경우 오류가 발생된다.
-- 값을 넣어주거나 기본 값 설정을 해줘야 한다.
INSERT INTO user_notnull
	(user_no, user_id, user_pwd, user_name, gender)
VALUES
	(5, 'user05', 'pass05', '금길동', '남');
	
/* unique 제약 조건*/
-- unique 제약 조건은 중복되는 값을 허용하지 않는 제약 조건이다.
...
SELECT * FROM user_unique_test; # 값이 비어있는 것이기 때문에 UNIQUE 제약 조건에 해당되지 않음
...
-- primary key는 unique 제약 조건으로 인해 중복되는 값을 허용하지 않는다.
INSERT INTO user_primarykey
	(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
	(1, 'user01', 'pass01', '홍길동', '남', '010-2322-2323', 'hong123@gmail.com');
...
INSERT INTO user_primarykey
	(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
	(null, 'user01', 'pass01', '홍길동', '남', '010-2322-2323', 'hong123@gmail.com');
...
-- age의 check 제약 조건을 확인하면 age >= 19로 설정이 되어 있기 때문에 오류가 발생되는 것이다.
INSERT INTO user_check
VALUES
	(NULL, '유관순', '여', 17);
